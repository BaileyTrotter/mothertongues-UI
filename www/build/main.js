...
var Flashcard = /** @class */ (function () {
    ...
    Flashcard.prototype.hasKey = function (obj, key) {
...
var WordModal = /** @class */ (function () {
    ...
    WordModal.prototype.hasKey = function (obj, key) {
        return obj.hasOwnProperty(key);
    };
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/Users/pinea/bailey-mtd-ui/src/app/app.html"*/'<!--<ion-split-pane [when]="isiPad">-->\n  <ion-menu [content]="content">\n    <ion-header>\n      <ion-toolbar>\n        <ion-title>Menu</ion-title>\n      </ion-toolbar>\n    </ion-header>\n\n    <ion-content scrollbar-y-auto on-swipe-right="menuOpen">\n      <ion-list>\n        <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n        {{p.title}}\n      </button>\n      </ion-list>\n    </ion-content>\n\n  </ion-menu>\n\n  <!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n  <ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>\n<!--</ion-split-pane>-->'/*ion-inline-end:"/Users/pinea/bailey-mtd-ui/src/app/app.html"*/
        }),
...
var Search = /** @class */ (function () {
    ...
    Search.prototype.getResults = function () {
        ...
        if (this.searchQuery.length > 1) {
            ...
            var searchQuery = this.searchQuery.normalize("NFC");
